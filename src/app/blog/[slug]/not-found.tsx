...
export default async function NotFound() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[calc(100dvh_-_68px)] p-4 text-center">
      <div className="md:max-w-md mx-auto w-full rounded-lg border border-slate-200 bg-white/50 p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900/30">
