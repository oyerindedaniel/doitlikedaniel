...
date: "2025-01-01"
excerpt: "Example for testing TypeScript code blocks"
tags: ["test"]
author: "Test"
...
This is a test file for TypeScript code blocks.

<TSCodeBlock filename="todo-example.ts" editable={true} height="350px" id="fixed-todo-example">
